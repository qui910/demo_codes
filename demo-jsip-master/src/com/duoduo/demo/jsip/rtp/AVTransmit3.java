/*
 * @(#)AVTransmit3.java 1.2 01/03/13 Transmitting and Receiving RTP over Custom Transport Layer Copyright (c) 1999-2001
 * Sun Microsystems, Inc. All Rights Reserved. Sun grants you ("Licensee") a non-exclusive, royalty free, license to
 * use, modify and redistribute this software in source and binary code form, provided that i) this copyright notice and
 * license appear on all copies of the software; and ii) Licensee does not utilize the software in a manner which is
 * disparaging to Sun. This software is provided "AS IS," without a warranty of any kind. ALL EXPRESS OR IMPLIED
...
public class AVTransmit3 {
	...
	public AVTransmit3(MediaLocator locator, String ipAddress, String pb, Format format) {
	...
	/**
	 * For JPEG and H263, we know that they only work for particular sizes. So we'll perform extra checking here to make
	 * sure they are of the right sizes.
	 */
	...
	public static void main(String[] args) {
		...
		AVTransmit3 at = new AVTransmit3(new MediaLocator(args[i]), args[i + 1], args[i + 2], fmt);
		// Start the transmission
