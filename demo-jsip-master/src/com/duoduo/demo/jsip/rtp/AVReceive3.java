/*
 * @(#)AVReceive3.java 1.2 01/03/13 Transmitting and Receiving RTP over Custom Transport Layer Copyright (c) 1999-2001
 ...
 */
public class AVReceive3 implements ReceiveStreamListener, SessionListener, ControllerListener {
	...
	protected boolean initialize() {
		...
		try {
			...
			for (int i = 0; i < sessions.length; i++) {
				...
				mgrs[i].initialize(new RTPSocketAdapter(InetAddress.getByName(session.addr), session.port, session.ttl));
