...
public class SipLayer implements SipListener {  
    ...
    public SipLayer(String username, String ip, int port) throws PeerUnavailableException, TransportNotSupportedException, InvalidArgumentException,  
    ...
    public void processRequest(RequestEvent evt) {  
        ...
        try {  
            ...
            toHeader.setTag("888");  
            // This is mandatory as per the spec.  
