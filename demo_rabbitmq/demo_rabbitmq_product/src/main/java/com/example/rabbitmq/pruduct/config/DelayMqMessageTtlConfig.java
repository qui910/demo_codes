...
/**
 * 通过死信队列 + Message Ttl 实现延迟消息
 * @author pang
 * @version 1.0
 * @date 2024-04-25 14:39
 * @since 1.8
 **/
@Configuration
public class DelayMqMessageTtlConfig {
    ...
    public Binding deadLetterBindingC(@Qualifier("deadLetterQueueC") Queue queue,
                                      @Qualifier("deadLetterExchangeA") DirectExchange exchange){
